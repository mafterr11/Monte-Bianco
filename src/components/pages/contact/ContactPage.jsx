...
const ContactPage = () => {
  return (
    <div className="mt-40 max-md:mt-32 md:max-xl:mt-28">
      {/* Titlu */}
      <motion.div
      ...
      >
        ...
        <h3 className="underline decoration-accent decoration-wavy underline-offset-4">
      ...
      <div className="mt-12 flex flex-col items-center justify-center gap-y-6 md:hidden">
        ...
        >
          ...
          >
            <span className="font-semibold text-black">Tel:</span> +40.722.577.771
          </a>
        </motion.div>
        {/* Fax */}
        <motion.div
        ...
        >
          ...
          <a
            href="https://maps.app.goo.gl/DnnwPTfXC7ykjhrz7"
            target="_blank"
            className="hover mt-1 text-center font-medium text-accent hover:decoration-2 hover:underline-offset-4"
          >
            Strada Fructelor, numărul 5, Pucioasa, Dâmbovița
          </a>
        </motion.div>
      </div>
      {/* Harta */}
      <motion.div
        ...
        whileInView={"show"}
        viewport={{ once: true, ammount: 0.4 }}
        className="container mx-auto mt-32 flex h-[900px] max-w-[1440px] flex-col-reverse gap-y-10 px-5 py-12 max-md:h-[200px] md:max-xl:mt-12 xl:pt-40"
      >
            ...
            <div className="relative mb-4 flex flex-wrap items-center justify-start rounded-sm bg-body/90 p-2 shadow-button drop-shadow-lg lg:bg-body">
              ...
              <div className="flex flex-col px-6 md:w-[350px]">
                ...
                <a
                  href="https://maps.app.goo.gl/p1wcRJjfmqQvtwxq8"
                  target="_blank"
                  className="hover mt-1 text-[17px] font-medium text-accent hover:scale-[1.02] hover:decoration-2 hover:underline-offset-4"
                >
                  Strada Laminorului, numărul 16, Târgoviște, Dâmboviţa
                </a>
              </div>
              ...
              <div className="hidden items-center justify-center gap-x-4 rounded-sm bg-body/90 p-2 text-lg shadow-button drop-shadow-lg md:flex lg:bg-body">
                ...
                <div className="flex-col flex-wrap md:flex">
                  ...
                  <a
                    href="tel:+40722577771"
                    target="blank"
                    className="text-[17px] font-medium text-accent hover:scale-[1.02] hover:underline hover:decoration-2 hover:underline-offset-4"
                  >
                    +40.722.577.771
                  </a>
                </div>
            ...
            <AnimatedTooltip message="Emailul departamentului de vânzări">
              <div className="hidden flex-col flex-wrap items-start justify-start rounded-sm bg-body/90 px-3 py-2 text-lg shadow-button drop-shadow-lg md:flex lg:bg-body">
                ...
                <a
                  href="mailto: sales@montebianco.ro"
                  target="blank"
                  className="flex items-center justify-center gap-x-1 text-[17px] font-medium text-accent hover:scale-[1.02] hover:underline hover:decoration-2 hover:underline-offset-4"
                >
                  sales@montebianco.ro
                </a>
              </div>
