...
const About = () => {
  return (
    <section className="max-md:pb-12 pb-40">
        {/* Container 1 */}
        <div className="flex flex-col md:flex-row items-center justify-center gap-x-32 max-md:gap-y-8 bg-body-accent max-md:py-10 xl:py-24 max-md:px-4">
            {/* Image */}
            <div>
            ...
            {/* Text */}
            <div>
                <h3 className="max-w-[430px] mb-5 text-accent leading-normal">Misiunea noastra: Lider a produselor de profil</h3>
         ...
         {/* Container 2 */}
         <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-x-32 max-md:gap-y-8 max-md:py-10 xl:py-28 max-md:px-4">
            {/* Text */}
            <div>
                <h3 className="max-w-[430px] mb-5 text-accent leading-normal">Povestea noastra</h3>
         ...
         <div className="flex flex-col md:flex-row items-center justify-center gap-x-32 max-md:gap-y-8 bg-body-accent max-md:py-10 xl:py-24 max-md:px-4">
            ...
            {/* Text */}
            <div>
                <h3 className="max-w-[430px] mb-5 text-accent leading-normal">Obiectivele Monte Bianco</h3>
