  ...
  return (
    <>
      <Link href={`${basePath}/${product.slug}`}>
        <Card className='bg-body-accent/20 border-2 group overflow-hidden relative border-black/15 h-[520px] flex flex-col md:max-xl:w-[400px] group hover:cursor-pointer'>
