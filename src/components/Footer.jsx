...
const Footer = () => {
  return (
    <footer className='bg-body-accent flex max-md:flex-col items-center justify-between max-md:gap-y-2 max-md:px-6 xl:px-[88px] py-[22px]'>
        ...
        {/* Center */}
        <div className='text-[13px]'>Creat de <Link href="https://www.myriad-tech.ro/" className='hover hover:font-medium'><span>Myriad Tech</span></Link> @ 2024 Monte Bianco</div>
        {/* Right side */}
        {/* Logo */}
